...
namespace FastReplicate.Tests
{
    public class FastReplicateReflectionTest
    {
        static FastReplicateReflectionTest()
        {
            TestUtils.Init();
        }
        ...
        private static ReflectionTestManager Manager()
        {
            ...
            return _manager = new ReflectionTestManager().Init(typeof(FastReplicatePlugin).Assembly);
        }
